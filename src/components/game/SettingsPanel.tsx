...
export function SettingsPanel() {
  const { showAllMoves, animateMoves, rotateBoard, showTriangleLines, showLastMoves, showCoordinates, autoConfirm, toggleShowAllMoves, toggleAnimateMoves, toggleRotateBoard, toggleTriangleLines, toggleShowLastMoves, toggleShowCoordinates, toggleAutoConfirm } = useSettingsStore();
