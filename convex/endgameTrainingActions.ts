...
const SEED_PUZZLES = [
  ...
  // ── Curated 3-move puzzles (top triangle, player-0 goal) ──────────────────
  {
    name: 'Curated · Straggler at 4,-3',
  ...
  {
    name: 'Curated · Straggler at 4,-3 (missing 3,-6)',
